...
// }
// 
// void drivingConstraint::define(kinematicConstraint* kc, drivingConstraintType td, double val)
// {
...
// 	kconst = kc;
// 	type = td;
// 	if (type == DRIVING_DISPLACEMENT){
// 
// 	}
// 	else if (type == DRIVING_VELOCITY){
// 		if (kconst->constType() == kinematicConstraint::REVOLUTE) {
...
// 			maxnnz += 4;
// 		}
// 		if (kconst->constType() == kinematicConstraint::TRANSLATIONAL) {
// 			init_t = kc->iMass()->Position();
...
// 	VEC3D ipos = kconst->iMass()->Position();
